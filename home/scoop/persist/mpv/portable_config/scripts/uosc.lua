...
render = render_menu,
      ...
      function Menu:enable_key_bindings()
        ...
        menu:add_key_binding('K',         'menu-page-up',     self:create_action('on_pgup'),  'repeatable')
        menu:add_key_binding('J',         'menu-page-down',   self:create_action('on_pgdwn'), 'repeatable')
        menu:add_key_binding('g',         'menu-home',        self:create_action('on_home'))
        menu:add_key_binding('G',         'menu-end',         self:create_action('on_end'))
      end
